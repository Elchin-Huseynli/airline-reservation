package com.airline.common_ms.model.enums;
...
public class Exceptions extends CommonException {
    public static final CommonException AIRPORT_NOT_FOUND = new  CommonException("Airport not found!", HttpStatus.NOT_FOUND);
